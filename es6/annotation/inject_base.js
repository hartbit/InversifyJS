    ...
    return (serviceIdentifier) => {
        return (target, targetKey, indexOrPropertyDescriptor) => {
            if (serviceIdentifier === undefined) {
                ...
                throw new Error(error_msgs_1.UNDEFINED_INJECT_ANNOTATION(className));
            }
            return decorator_utils_1.createTaggedDecorator(new metadata_1.Metadata(metadataKey, serviceIdentifier))(target, targetKey, indexOrPropertyDescriptor);
        };
    };
}
