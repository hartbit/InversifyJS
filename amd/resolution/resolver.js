...
define(["require", "exports", "../constants/error_msgs", "../constants/literal_types", "../planning/planner", "../scope/scope", "../utils/async", "../utils/binding_utils", "../utils/exceptions", "./instantiation"], function (require, exports, ERROR_MSGS, literal_types_1, planner_1, scope_1, async_1, binding_utils_1, exceptions_1, instantiation_1) {
    ...
    var _resolveFactoryFromBinding = function (binding, context) {
        var factoryDetails = binding_utils_1.getFactoryDetails(binding);
        return exceptions_1.tryAndThrowErrorIfStackOverflow(function () { return factoryDetails.factory.bind(binding)(context); }, function () { return new Error(ERROR_MSGS.CIRCULAR_DEPENDENCY_IN_FACTORY(factoryDetails.factoryType, context.currentRequest.serviceIdentifier.toString())); });
    };
    var _getResolvedFromBinding = function (requestScope, request, binding) {
        var result;
        var childRequests = request.childRequests;
        binding_utils_1.ensureFullyBound(binding);
        switch (binding.type) {
            ...
            case literal_types_1.BindingTypeEnum.Instance:
                result = instantiation_1.resolveInstance(binding, binding.implementationType, childRequests, _resolveRequest(requestScope));
                break;
            default:
    ...
    var _resolveInScope = function (requestScope, binding, resolveFromBinding) {
        var result = scope_1.tryGetFromScope(requestScope, binding);
        if (result !== null) {
            return result;
        }
        result = resolveFromBinding();
        scope_1.saveToScope(requestScope, binding, result);
        return result;
    };
    ...
    function _onActivation(request, binding, resolved) {
        ...
        } while (containersIteratorResult.done !== true && !planner_1.getBindingDictionary(container).hasKey(request.serviceIdentifier));
        return result;
    }
